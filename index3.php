...
<body>
    <div class="wrapper">
        <nav class="nav">
            <div class="nav-logo">
                <a href="index3.php"><img src="logo.png" alt="">
                    <span class="hname">WeCareMedical</span>
            </div>
            <div class="nav-menu" id="navMenu">
           <ul>
                <li><a href="index.php" class="mobile-only">Home</a></li>
                <li><a href="index3.php" class="mobile-only">Patient</a></li>
            ...
            <a href="index.php" >
              <button class="btn white-btn" >Home</button></a>
